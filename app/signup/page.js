  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-tagline">
        ...
        <p className="auth-sub">Free · No credit card · Start in seconds</p>
      </div>

      <div className="auth-actions">
        {/* Google sign up — same as sign in (Google handles both) */}
        <button
        ...
        <p className="auth-note">
          ...
          Your account gives you 100 messages/day and 20 image generations/day.
        </p>
      </div>
